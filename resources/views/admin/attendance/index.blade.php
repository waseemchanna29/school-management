...
@section('content')
    <div class="page-header">
        ...
        {{-- Add to page header d-flex gap-2 div --}}
        <a href="{{ route('admin.students.index') }}" class="btn-outline-primary btn btn-sm">
            <i class="fas fa-user-check"></i> By Student
        </a>
   ...
   class="btn-outline-primary btn btn-sm" title="View & Edit">
    <i class="fas fa-edit"></i>
                                    ...
                                    @if ($session->isLocked())
                                        <form action="{{ route('admin.attendance.unlock', $session) }}" method="POST"
