                    ...
                    <table class="data-table">
                                        ...
                                        <div style="display:flex; align-items:center; justify-content:center; gap:0.5rem;">
                                            <div class="perf-bar-wrap" style="width:60px;">
                                                <div class="perf-bar-fill"
                                                    style="width:{{ $avg }}%;
                                                background:{{ $avg >= 75 ? 'var(--success)' : ($avg >= 50 ? 'var(--warning)' : 'var(--danger)') }};">
                                                </div>
                                            </div>
                                            <strong
                                                style="color:{{ $avg >= 75 ? 'var(--success)' : ($avg >= 50 ? '#7a5800' : 'var(--danger)') }};">
                                                {{ $avg }}%
                                            </strong>
                                        </div>
                                    </td>
                        ...
                        <tfoot>
                            <tr style="background:var(--primary); color:var(--white);">
                                ...
                                <td
                                    style="text-align:center; padding:0.8rem 1rem; font-weight:700; color:var(--accent-light);">
