                    ...
                    <div class="row">
                        ...
                        <div class="mb-form">
                            ...
                            <select name="academic_year_id" class="form-select">
                                @foreach (\App\Models\AcademicYear::where('campus_id', \App\Helpers\CampusContext::id())->orderByDesc('start_date')->get() as $ay)
                                    <option value="{{ $ay->id }}"
                                        {{ $ay->id === \App\Helpers\AcademicYearContext::id() ? 'selected' : '' }}>
                                        {{ $ay->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div
                        ...
                        <div class="row">
                            <div class="mb-form col-4">
                                ...
                                <input type="number" name="outstanding" class="form-control" value="0" min="0"
                                    step="0.01" placeholder="Same for all">
                            </div>
                            <div class="mb-form col-4">
