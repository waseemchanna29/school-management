...
<div class="page-header">
    <div>
        ...
        <div class="page-header-sub">
            ...
            &bull; {{ $terms[$term] ?? "Term $term" }}
            &bull; {{ $academicYear }}
            @if($weight) &bull; Weight: <strong>{{ $weight->weight }}%</strong> @endif
        </div>
    </div>
...
<form method="GET" action="{{ route('teacher.performance.enter-marks', $subject) }}"
      class="mb-2 card no-print" style="border-left:4px solid var(--primary-light);">
    <div class="card-body">
    ...
    <div class="card-header">
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <input type="date" name="exam_date" class="form-control"
                   value="{{ old('exam_date', today()->toDateString()) }}"
                   style="width:160px;">
            ...
            <thead>
                <tr>
                    ...
                    <th style="text-align:center; min-width:120px;">
                        Marks <span style="font-weight:400; opacity:0.75;">(out of <span id="total-display">100</span>)</span>
                    </th>
            ...
            <tbody>
                ...
                <tr id="row-{{ $student->id }}">
                    ...
                    <td style="text-align:center;">
                        <input type="number"
                               name="marks[{{ $student->id }}][obtained]"
                               id="marks-{{ $student->id }}"
